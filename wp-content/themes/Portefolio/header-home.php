...
<header class="header">
    <h1 class="header__title">
        ...
        <span class="header__name"><?= get_field('text'); ?></span>
        <span class="header__job"><?= get_field('text_1'); ?></span>
    </h1>
    <div class="blocheader__flex flex blocheader__white">
        <div class="flex__logo">
            <a href="#" class="flex__logo__link link">
            ...
            <ul class="blocheader__menu__list menu aboutmenu">
                <?php foreach(port_get_menu('main')->getItems() as $item): ?>
                    <li class="menu__items">
                        <a href="<?= $item->url; ?>" class="menu__items__link" id="link"><?= $item->label; ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </nav>
